    ...
    <div id="fullpage">
        ...
        <div class="mainInfo mainT center-style" data-tilt>
          ...
          <div>
                ...
                <form action="<?php echo 'process2.php?id='.$id; ?>" class="ask-form" method="post">
                    ...
                    <div >
                      <input type="text" name="aff" class="form-inp" placeholder="Affiliation" >
                     
                    </div><br>

                    <div >
                        <input type="text" name="pp" class="form-inp" placeholder="Previous Partnerships" >
