        ...
        <div class="mainInfo mainT center-style" data-tilt>
          ...
          <div>
                ...
                <div class="form-wrapper">
                  ...
                  <form action="<?php echo 'process3.php?id='.$id; ?>" class="ask-form" method="post">
                    ...
                    <div >
                      <input type="text" name="nw" class="form-inp" placeholder="Net Worth" >
                     
                    </div><br>

                    <div >
                        <input type="text" name="cid" class="form-inp" placeholder="CId" >
