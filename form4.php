        ...
        <div class="mainInfo mainT center-style" data-tilt>
          ...
          <div>
                ...
                <div class="form-wrapper">
                  ...
                  <form action="<?php echo 'process4.php?id='.$id; ?>" class="ask-form" method="post">
                    ...
                    <div >
                      <input type="text" name="gl" class="form-inp" placeholder="General/Limited" >
                     
                    </div><br>

                    <div >
                        <input type="number" name="np" class="form-inp" placeholder="Number of Partnerships" >
