        ...
        <div class="mainInfo mainT center-style" data-tilt>
          ...
          <div>
                ...
                <div class="form-wrapper">
                  ...
                  <form action="<?php echo 'process6.php?id='.$id; ?>" class="ask-form" method="post">
                    ...
                    <div >
                        <input type="number" name="nw" class="form-inp" placeholder="Net Worth" >
                      </div><br>
                    ...
                    <div >
                        <input type="number" name="ss" class="form-inp" placeholder="Secretary" >
